...
var AppComponent = /** @class */ (function () {
    function AppComponent(router, googleAnalyticsEventsService, media, authService) {
        this.router = router;
...
var AuthIntercepter = /** @class */ (function () {
    function AuthIntercepter(authService) {
        this.authService = authService;
    }
...
var BACKED_URL = _environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].BACKED_URL;
var AuthService = /** @class */ (function () {
    ...
    // 로그인 처리
    AuthService.prototype.login = function (email, password, token) {
        var _this = this;
        // 형식틀을 정형화시킴
        var postData = {
            email: email,
        ...
        this.http.post(BACKED_URL + '/user/login', postData)
            ...
            if (token) {
                ...
                _this.nickname = response.nickname;
                ...
                // 껏다가 켜도 유지가 됨
                var now = new Date();
                var expirationDate = new Date(now.getTime() + expiresInDuration * 1000); // 실제 종료시간 측정
                console.log(expirationDate);
                _this.saveAuthData(token, expirationDate, _this.userId, _this.nickname, _this.avatar);
    ...
    // 회원가입 처리
    AuthService.prototype.createUser = function (email, password, firstName, lastName, nickName, gender, token) {
        var _this = this;
        var authCreateData = {
            email: email,
            password: password,
    ...
    // 로컬저장소에 저장하는 메소드
    AuthService.prototype.saveAuthData = function (token, expirationDate, userId, nickname, avatar) {
    ...
    // 회원정보 요청
    AuthService.prototype.getUserAccount = function () {
        var queryParams = "?email=" + this.getUserData().userId;
        // 로그인 정보를 서버에 보냄
        return this.http.get(BACKED_URL +
            '/user/search' + queryParams);
    };
    // 회원정보 수정
    AuthService.prototype.setUserAccount = function (password, imagePath, nickname) {
        var _this = this;
        var postData;
    ...
    // 비번 리셋을 위한 확인 이메일
    AuthService.prototype.confirmUser = function (email) {
        console.log('이거 진짜 2번 보내지는거냐?');
        this.http.get(BACKED_URL + '/user/confirm?email=' + email)
            .subscribe(function () {
        });
    };
    AuthService.prototype.passwordReset = function (email, key, password) {
        var _this = this;
        var postData = {
            email: email,
            key: key,
    ...
    AuthService.prototype.getUserAuthority = function () {
        var _this = this;
        this.http.get(BACKED_URL + '/user/authority')
            .subscribe(function (email) {
            _this.userAuthority.next(email);
            // console.log(email);
        });
    };
...
var HelpComponent = /** @class */ (function () {
    ...
    HelpComponent.prototype.onNgSubmit = function (emailForm) {
...
/* harmony import */ var ng_recaptcha__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ng-recaptcha */ "./node_modules/ng-recaptcha/fesm5/ng-recaptcha.js");
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(authService, router, recaptchaV3Service) {
        this.authService = authService;
        this.router = router;
    ...
    LoginComponent.prototype.ngOnInit = function () {
        ...
        this.authStatusSub = this.authService.getAuthStatusListener().subscribe(function (authStatus) {
            if (authStatus) { // 로그인 성공하면
                ...
                _this.authService.getUserAuthority();
            }
            else { // 로그인 실패하면
                _this.isLoding = false;
            }
    ...
    LoginComponent.prototype.onNgSubmit = function (loginForm) {
        var _this = this;
        ...
        this.singleExecutionSubscription = this.recaptchaV3Service.execute('login')
            ...
            _this.recentToken = token;
            _this.isLoding = true;
            _this.authService.login(loginForm.value.email, loginForm.value.password, _this.recentToken);
        });
    };
...
var ResetComponent = /** @class */ (function () {
    function ResetComponent(route, authService) {
        this.route = route;
        this.authService = authService;
    }
...
var PasswordValidator = /** @class */ (function () {
    ...
    PasswordValidator.match = function (form) {
...
/* harmony import */ var ng_recaptcha__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ng-recaptcha */ "./node_modules/ng-recaptcha/fesm5/ng-recaptcha.js");
...
var SignupComponent = /** @class */ (function () {
    function SignupComponent(authService, recaptchaV3Service) {
        this.authService = authService;
        this.recaptchaV3Service = recaptchaV3Service;
        this.isLoding = false;
        this.recentToken = "";
    ...
    SignupComponent.prototype.onSubmit = function () {
        ...
        this.singleExecutionSubscription = this.recaptchaV3Service
            ...
            _this.recentToken = token;
            _this.isLoding = true;
            _this.authService.createUser(_this.signupForm.value.email, _this.signupForm.value.passwordGroup.password, _this.signupForm.value.firstName, _this.signupForm.value.lastName, _this.signupForm.value.nickName, _this.signupForm.value.gender, _this.recentToken);
        });
    };
...
var BodyComponent = /** @class */ (function () {
    function BodyComponent(router, location, catergoryService) {
        this.router = router;
    ...
    BodyComponent.prototype.ngAfterViewInit = function () {
        var _this = this;
        this.loactionEvent = this.location.subscribe(function (ev) {
            // console.log('location : ' + ev.url);
            _this.lastPoppedUrl = ev.url;
            _this.loactionEvent.unsubscribe();
        });
        this.routerEvent = this.router.events.subscribe(function (ev) {
            if (ev instanceof _angular_router__WEBPACK_IMPORTED_MODULE_2__["NavigationStart"]) {
                ...
                if (ev.url !== _this.lastPoppedUrl) {
                    _this.catergoryService.setyScrollStack(window.scrollY);
                }
            }
                ...
                if (ev.url === _this.lastPoppedUrl) { // 이전 url과 같으면.. 그니까 되돌아가는거면 복원
                    _this.lastPoppedUrl = undefined;
                    // this.catergoryService.getyScrollStack();
                    // console.log('복원 : ' + this.catergoryService.getyScrollStack());
                    window.scrollTo(0, _this.catergoryService.getyScrollStack());
                }
                else { // 아니라면 탑
                    window.scrollTo(0, 0);
                }
                _this.routerEvent.unsubscribe();
            }
        });
    };
    BodyComponent.prototype.ngOnInit = function () {
    };
    BodyComponent.prototype.onNgSubmit = function (searchForm) {
...
var CatergoryComponent = /** @class */ (function () {
    function CatergoryComponent(catergoryService) {
        this.catergoryService = catergoryService;
    }
    ...
    CatergoryComponent.prototype.onScrollDown = function () {
        this.catergoryService.onScrollDownEvent.next();
    };
    CatergoryComponent.ctorParameters = function () { return [
...
var CatergoryModule = /** @class */ (function () {
    function CatergoryModule() {
    }
...
var BACKED_URL = src_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].BACKED_URL;
var CatergoryService = /** @class */ (function () {
    ...
    // 스크롤 저장
    CatergoryService.prototype.setyScrollStack = function (yScroll) {
        console.log('스크롤 저장 : ' + yScroll);
        this.yScrollStack.push(yScroll);
    };
    // 스크롤 불러오기
    CatergoryService.prototype.getyScrollStack = function () {
        console.log('스크롤 호출 : ');
        return this.yScrollStack.pop();
    };
    // 게시글 리스트 불러오기(5개씩)
    CatergoryService.prototype.getPosts = function (catergory, pages, router) {
        var _this = this;
        if (this.router === router && router !== undefined) { // 라우터에 변화가 없다면 기존 posts를 전달
            ...
            this.pages = pages;
            var queryParams = "?catergory=" + catergory + "&pages=" + this.pages;
            this.http.get(BACKED_URL + '/post' + queryParams)
                ...
                (_a = _this.posts).push.apply(_a, tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](transformedPosts));
                _this.postsChanged.next({
                    change: false,
    ...
    CatergoryService.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"] }
    ]; };
...
var CatergoryNewlyComponent = /** @class */ (function () {
    function CatergoryNewlyComponent(postsService, route, authService, likeHateService, catergoryService) {
    ...
    CatergoryNewlyComponent.prototype.ngOnInit = function () {
        var _this = this;
        var nav = new _nav_nav_model__WEBPACK_IMPORTED_MODULE_5__["Nav"]();
        this.pages = 1;
        this.postsChangedEvent = this.catergoryService.postsChanged.subscribe(function (postData) {
            _this.isLoding = false;
            if (postData.change === true) { // 처음부터 리셋
                _this.pages = postData.pages;
        ...
        this.route.params.subscribe(function (params) {
            _this.catergoryName = params.postId; // 현경로
            _this.catergory = nav.catergory.filter(function (catergory) {
                return catergory.fileNav === _this.catergoryName;
            });
            _this.isLoding = true;
            _this.isFinish = false;
            // 해당 카테고리에 맞는 포스트를 요청
            _this.catergoryService.getPosts(_this.catergoryName, _this.pages, params.postId);
        });
        // scrollDownEvnet발생시...
        this.scrollDownEvent = this.catergoryService.onScrollDownEvent.subscribe(function () {
            _this.isLoding = true;
            _this.pages++;
            _this.catergoryService.getPosts(_this.catergoryName, _this.pages);
        });
    };
    // 공감수 +1 증가
    CatergoryNewlyComponent.prototype.increase = function (postNo) {
    ...
    // 공감수 -1 감소
    CatergoryNewlyComponent.prototype.decrease = function (postNo) {
        if (!this.authService.getIsAuth()) {
            alert('login ahead!!');
            return;
        }
    ...
    CatergoryNewlyComponent.prototype.ngOnDestroy = function () {
        this.scrollDownEvent.unsubscribe();
        this.postsChangedEvent.unsubscribe();
    };
    CatergoryNewlyComponent.ctorParameters = function () { return [
    ...
    return CatergoryNewlyComponent;
}());
...
var CatergoryPopularComponent = /** @class */ (function () {
    function CatergoryPopularComponent(route, postService, authService) {
        this.route = route;
        this.postService = postService;
        this.authService = authService;
    }
    CatergoryPopularComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.isAuth = this.authService.getIsAuth();
        var nav = new _nav_nav_model__WEBPACK_IMPORTED_MODULE_5__["Nav"]();
        // 현재 카테고리를 url를 통해 알아내는 코드
        this.route.params.subscribe(function (param) {
            _this.catergoryName = param.postId;
            _this.catergory = nav.catergory.filter(function (catergory) {
                return catergory.fileNav === _this.catergoryName;
            });
            _this.postService.getPopularPosts(_this.catergoryName); // 알아낸 카테고리를 통해 이 카테고리에 인기글을 요청
        });
        // 이 카테고리에 인기글을 요청한 결과
        this.popularPostSub = this.postService.popularPostUpdated
            .subscribe(function (posts) {
            _this.popularPost = posts;
            _this.popularPost.forEach(function (post) {
                post.content = post.content.replace(/(<([^>]+)>)/ig, "");
            });
        });
    };
    CatergoryPopularComponent.prototype.ngOnDestroy = function () {
        this.popularPostSub.unsubscribe();
    };
    CatergoryPopularComponent.ctorParameters = function () { return [
    ...
    return CatergoryPopularComponent;
}());
...
var BACKED_URL = src_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].BACKED_URL;
var MainPostService = /** @class */ (function () {
    function MainPostService(http) {
        this.http = http;
    }
    // 인기 게시글 조회
    MainPostService.prototype.getPopularPosts = function () {
        return this.http.get(BACKED_URL + '/post/main-popular');
    };
    // 최신 게시글 조회
    MainPostService.prototype.getNewlyPosts = function () {
        return this.http.get(BACKED_URL + '/post/main-newly');
    };
    MainPostService.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"] }
    ]; };
...
var NewPostComponent = /** @class */ (function () {
    function NewPostComponent(mainPostService) {
    ...
    NewPostComponent.prototype.ngOnInit = function () {
        ...
        this.mainPostService.getNewlyPosts()
            ...
            _this.newlyPost = postData.posts;
            _this.newlyPost.forEach(function (post) {
...
var PopularPostComponent = /** @class */ (function () {
    function PopularPostComponent(mainPostService) {
        this.mainPostService = mainPostService;
    }
    PopularPostComponent.prototype.ngOnInit = function () {
        ...
        this.mainPostService.getPopularPosts()
            .subscribe(function (postData) {
            _this.popularPost = postData.posts;
            _this.popularPost.forEach(function (post) {
                post.curtContent = post.content.replace(/(<([^>]+)>)/ig, "");
            });
        });
...
var NavComponent = /** @class */ (function () {
    ...
    NavComponent.prototype.ngOnInit = function () {
        var nav = new _nav_model__WEBPACK_IMPORTED_MODULE_2__["Nav"]();
...
var SearchComponent = /** @class */ (function () {
    function SearchComponent(activatedRoute, postsService) {
    ...
    SearchComponent.prototype.ngOnInit = function () {
        ...
        this.activatedRoute.queryParams.subscribe(function (params) {
            _this.posts = [];
            _this.pages = 1;
            _this.isLoding = _this.isFinish = false;
            _this.searchInput = params['searchInput'];
            _this.postsService.getSearchPost(_this.searchInput, _this.pages)
                .subscribe(function (searchPost) {
                _this.isLoding = false;
                _this.posts = _this.posts.concat(searchPost.posts);
                _this.posts.forEach(function (post) {
                    ...
                    */
                    post.title = post.title.replace(new RegExp(_this.searchInput, "gi"), function (match) {
                        return '<span class="marker">' + match + '</span>';
                    });
                    post.curtContent = post.curtContent.replace(new RegExp(_this.searchInput, "gi"), function (match) {
                        return '<span class="marker">' + match + '</span>';
                    });
                });
            });
    ...
    SearchComponent.prototype.onScrollDown = function () {
        var _this = this;
        this.isLoding = true;
        this.pages++;
...
var UserPostComponent = /** @class */ (function () {
    function UserPostComponent(authService, postsService) {
        this.authService = authService;
        this.postsService = postsService;
        this.posts = [];
        this.isFinish = false;
    ...
    UserPostComponent.prototype.ngOnInit = function () {
        ...
        this.postsService.getMyPosts(this.nickname, this.pages)
            .subscribe(function (myPost) {
            _this.isLoding = false;
            _this.posts = _this.posts.concat(myPost.posts);
            _this.posts.forEach(function (post) {
                post.curtContent = post.content.replace(/(<([^>]+)>)/ig, "");
            });
        });
    };
    UserPostComponent.prototype.onScrollDown = function () {
        var _this = this;
        this.isLoding = true;
        this.pages++;
        this.postsService.getMyPosts(this.nickname, this.pages)
    ...
    UserPostComponent.ctorParameters = function () { return [
...
var UserSettingComponent = /** @class */ (function () {
    function UserSettingComponent(authService) {
        this.authService = authService;
        this.userData = {
            email: '',
            nickname: '',
    ...
    UserSettingComponent.prototype.ngOnInit = function () {
        ...
        this.authService.getUserAccount()
            .subscribe(function (userDate) {
            _this.userData.firstname = userDate.first_name;
            _this.userData.lastname = userDate.last_name;
            _this.userData.avatar = userDate.avatar;
            _this.userData.gender = userDate.gender;
        });
    };
    UserSettingComponent.prototype.onUpdate = function () {
        this.mode = 'update';
    ...
    UserSettingComponent.prototype.onImagePicked = function (event) {
        var _this = this;
...
var ErrorInterceptor = /** @class */ (function () {
    ...
    ErrorInterceptor.prototype.intercept = function (req, next) {
        ...
        return next.handle(req).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(function (error) {
            ...
            _this.dialog.open(_error_error_component__WEBPACK_IMPORTED_MODULE_2__["ErrorComponent"], { data: { message: errorMessage } });
...
var HeaderComponent = /** @class */ (function () {
    function HeaderComponent(changeDetectorRef, media, authService, postsService, router) {
        this.authService = authService;
        this.postsService = postsService;
        this.router = router;
        this.adminEmail = [];
    ...
    HeaderComponent.prototype.ngOnInit = function () {
        var _this = this;
        var nav = new _body_nav_nav_model__WEBPACK_IMPORTED_MODULE_4__["Nav"]();
        this.catergory = nav.catergory;
        // 인증여부가져옴
        ...
        this.authoListenerSubs = this.authService
            ...
            _this.userData = _this.authService.getUserData();
        });
        this.userAuthoritySub = this.authService.userAuthority.subscribe(function (adminemail) {
            _this.adminEmail = adminemail.email;
            console.log(_this.adminEmail[0]);
    ...
    HeaderComponent.prototype.onNgSubmit = function (searchForm) {
        if (searchForm.invalid) {
            return;
        }
        this.router.navigate(['/search'], { queryParams: { searchInput: searchForm.value.searchInput } });
    };
    HeaderComponent.prototype.sidenavClose = function () {
        this.snav.close();
    };
...
var NgxSummernoteDirective = /** @class */ (function () {
    ...
    NgxSummernoteDirective_1 = NgxSummernoteDirective;
    ...
    NgxSummernoteDirective.prototype.ngOnInit = function () {
    ...
    NgxSummernoteDirective.prototype.ngOnChanges = function (changes) {
    ...
    NgxSummernoteDirective.prototype.ngOnDestroy = function () {
        this.destroyEditor();
    };
    // Form model content changed.
    NgxSummernoteDirective.prototype.writeValue = function (content) {
        this.updateEditor(content);
    };
    NgxSummernoteDirective.prototype.registerOnChange = function (fn) { this.onChange = fn; };
    NgxSummernoteDirective.prototype.registerOnTouched = function (fn) { this.onTouched = fn; };
    // Update editor with model contents.
    NgxSummernoteDirective.prototype.updateEditor = function (content) {
    ...
    NgxSummernoteDirective.prototype.updateModel = function (content) {
        var _this = this;
    ...
    NgxSummernoteDirective.prototype.initListeners = function () {
        var self = this;
        if (!this._$element) {
            return;
        }
    ...
    NgxSummernoteDirective.prototype.createEditor = function () {
        var _this = this;
        if (this._editorInitialized) {
            return;
        }
    ...
    NgxSummernoteDirective.prototype.setHtml = function () {
        this._$element.summernote('code', this._model || '', true);
    };
    NgxSummernoteDirective.prototype.setContent = function (firstTime) {
    ...
    NgxSummernoteDirective.prototype.destroyEditor = function () {
        if (this._editorInitialized) {
    ...
    NgxSummernoteDirective.prototype.getEditor = function () {
        if (this._$element) {
    ...
    // TODO not sure it works now...
    NgxSummernoteDirective.prototype.generateManualController = function () {
        var controls = {
    ...
    NgxSummernoteDirective.prototype.uploadImage = function (files) {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                ...
                if (this._options.uploadImagePath) {
                    this.http.post(this._options.uploadImagePath, data)
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (response) { return response && typeof response.path === 'string' && response.path; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(function (e) {
    ...
    NgxSummernoteDirective.prototype.insertFromDataURL = function (files) {
        var _this = this;
        var reader = new FileReader();
    ...
    NgxSummernoteDirective = NgxSummernoteDirective_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Directive"])({
            ...
            providers: [{
                    ...
                    useExisting: Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["forwardRef"])(function () { return NgxSummernoteDirective_1; }),
                    multi: true
                }]
        })
...
var BACKED_URL = _environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].BACKED_URL;
var PostCreateComponent = /** @class */ (function () {
    function PostCreateComponent(postService, route, router, recaptchaV3Service) {
        this.postService = postService;
        this.route = route;
        this.router = router;
        this.recaptchaV3Service = recaptchaV3Service;
        this.mode = 'create';
        this.recentToken = '';
        var nav = new src_app_body_nav_nav_model__WEBPACK_IMPORTED_MODULE_6__["Nav"]();
        this.catergory = nav.catergory;
    ...
    PostCreateComponent.prototype.ngOnInit = function () {
        ...
        this.route.paramMap.subscribe(function (paramMap) {
            if (paramMap.has('postId')) { // 게시글 id가 url에 존재한다면 이것은 게시글 modify모드라는 소리임.
                ...
                _this.postService.getEachPost(_this.postId).subscribe(function (postData) {
                    _this.post = postData.post;
                    _this.postForm.setValue({
                        'title': _this.post.title,
                        'catergory': _this.post.catergory,
  ...
  */
    ...
    PostCreateComponent.prototype.onNgSubmit = function () {
        var _this = this;
        ...
        this.singleExecutionSubscription = this.recaptchaV3Service.execute('post')
            .subscribe(function (token) {
            _this.recentToken = token;
            var rex = /<img[^>]+src="([^">]+)/g; // 이미지 src추출 정규식
            _this.imagePath = rex.exec(_this.postForm.value.content);
            if (_this.imagePath === null) {
                _this.realImagePath = null;
            }
            else {
                _this.realImagePath = _this.imagePath[1];
            }
            if (_this.mode === 'create') {
                ...
                _this.postService.addPost(_this.postForm.value.title, _this.postForm.value.catergory, _this.postForm.value.content, _this.realImagePath, _this.recentToken);
            }
            else {
                _this.postService.updatePost(_this.postId, _this.postForm.value.title, _this.postForm.value.content, _this.realImagePath);
            }
        });
        /*
...
var PostListComponent = /** @class */ (function () {
    function PostListComponent(router, postService, authService, likeHateService, recaptchaV3Service) {
        this.router = router;
        this.postService = postService;
        this.authService = authService;
        this.likeHateService = likeHateService;
    ...
    PostListComponent.prototype.ngOnInit = function () {
        ...
        this.postService.getEachPost(this.postNo)
            .subscribe(function (postData) {
            _this.post = postData.post;
            if (_this.post.reply_cnt > _this.pages * 10) {
        ...
        this.likeHateSub = this.likeHateService.getlikeHateUpdatedUpdateListener()
            .subscribe(function (likeHate) {
            _this.likeHate = likeHate;
            if (_this.userNickname !== undefined) {
                if (_this.likeHate.mylike === 'Y') {
                    _this.isLike = true;
                }
                else {
                    _this.isLike = false;
                }
                if (_this.likeHate.myhate === 'Y') {
                    _this.isHate = true;
                }
                else {
                    _this.isHate = false;
        ...
        this.postService.getReply(this.postNo, this.pages)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["map"])(function (replyData) {
            return replyData.reply.map(function (reply) {
                return {
            ...
            .subscribe(function (transformedReply) {
            _this.replys = _this.replys.concat(transformedReply);
            if (_this.post.reply_cnt > _this.pages * 10) {
                _this.addButton = true;
            }
            else {
    ...
    // 댓글 저장
    PostListComponent.prototype.onNgReplySubmit = function (replyForm) {
        var _this = this;
        // 로그인하지 않은 사용자는 댓글 못씀
        if (!this.authService.getIsAuth()) {
            alert('login ahead!');
        ...
        var content = replyForm.value.reply;
        this.singleExecutionSubscription = this.recaptchaV3Service.execute('reply')
            .subscribe(function (token) {
            _this.recentToken = token;
            _this.postService.addReply(_this.postNo, _this.authService.getUserData().userNickname, content, _this.recentToken).subscribe(function (replyNo) {
                _this.replys.push({
                    post_no: _this.post.post_no,
                    reply_no: replyNo.replyNo,
                    writer: _this.userNickname,
                    content: content,
                    reply_date: new Date(),
                    count: 0,
                    reply_view: false
    ...
    // 덧글 저장
    PostListComponent.prototype.onNgRReplySubmit = function (replyForm, replyParentNo) {
        var _this = this;
        if (!this.authService.getIsAuth()) {
            alert('login ahead!');
        ...
        var content = replyForm.value.rreply;
        this.singleExecutionSubscription = this.recaptchaV3Service.execute('reply')
            .subscribe(function (token) {
            _this.recentToken = token;
            _this.postService.addRReply(_this.postNo, _this.authService.getUserData().userNickname, replyForm.value.rreply, replyParentNo, _this.recentToken)
                .subscribe(function (replyNo) {
                _this.rreplys.push({
                    post_no: _this.post.post_no,
                    reply_no: replyNo.replyNo,
                    writer: _this.userNickname,
    ...
    // 덧글 보기 선택
    PostListComponent.prototype.selectItem = function (replyNo) {
        var _this = this;
        this.replys.forEach(function (replys) {
        ...
        this.rreplySub = this.postService.getRReply(this.postNo, replyNo, 1)
            .subscribe(function (replys) {
            _this.rreplys = replys.reply;
        });
    };
    // 더보기 버튼 클릭시
    PostListComponent.prototype.onloadReply = function () {
        var _this = this;
        this.pages++;
        this.postService.getReply(this.postNo, this.pages)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["map"])(function (replyData) {
    ...
    // 게시글 삭제
    PostListComponent.prototype.onDelete = function (postNo) {
        this.postService.deletePost(postNo);
    };
    // 좋아요, 싫어요
    PostListComponent.prototype.onVote = function (likeHate) {
        this.likeHateService.setLikeCount(this.postNo, this.userNickname, likeHate);
    };
    // 댓, 답글 삭제
    PostListComponent.prototype.onReplyDelete = function (idx, replyNo, parent) {
        var _this = this;
        var result = confirm('Are you sure you want to delete the comments?');
        if (result) {
            this.postService.deleteReply(this.postNo, replyNo, parent).subscribe(function () {
                if (!parent) { // 댓글일때
                    _this.replys.splice(idx, 1);
                }
                else { // 답글일때
                    _this.rreplys.splice(idx, 1);
                }
            });
        }
        else {
...
var BACKED_URL = src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].BACKED_URL;
var LikeHateService = /** @class */ (function () {
    function LikeHateService(http) {
        this.http = http;
        this.likeHateUpdated = new rxjs__WEBPACK_IMPORTED_MODULE_4__["Subject"]();
    }
    LikeHateService.prototype.getlikeHateUpdatedUpdateListener = function () {
        return this.likeHateUpdated.asObservable();
    };
    // 공감 비공감 처리하기
    LikeHateService.prototype.setLikeCount = function (postNo, nickname, like) {
        var _this = this;
        var postData = {
            postNo: postNo,
            nickname: nickname,
        ...
        this.http.post(BACKED_URL + '/post/like', postData)
            .subscribe(function () {
            _this.getLikeHateCount(postNo, nickname);
        });
    };
    // 공감 비공감 불러오기
    LikeHateService.prototype.getLikeHateCount = function (postNo, nickname) {
        var _this = this;
        var queryParams = "?postNo=" + postNo + "&nickname=" + nickname;
        this.http.get(BACKED_URL + '/post/like' + queryParams)
            .subscribe(function (likeData) {
            _this.likeHateUpdated.next(likeData.likeHate);
        });
    };
    LikeHateService.ctorParameters = function () { return [
...
var BACKED_URL = _environments_environment__WEBPACK_IMPORTED_MODULE_7__["environment"].BACKED_URL;
var PostService = /** @class */ (function () {
    function PostService(http, router, authService, location) {
        this.http = http;
        this.router = router;
        this.authService = authService;
        this.location = location;
    ...
    // 인기 게시글 조회
    PostService.prototype.getPopularPosts = function (catergory) {
        var _this = this;
        var queryParams = "?catergory=" + catergory;
        this.http.get(BACKED_URL + '/post/popular' + queryParams)
            .subscribe(function (popularData) {
            _this.popularPostUpdated.next(popularData.posts);
        });
    };
    // 개별 게시글 조회
    PostService.prototype.getEachPost = function (postNo) {
        console.log('dd');
        return this.http.get(BACKED_URL + '/post/postEach/' + postNo);
    };
    // 게시글 저장하기
    PostService.prototype.addPost = function (title, catergory, content, imagePath, token) {
        var _this = this;
        var writer = this.authService.getUserData().userNickname;
        var postData = {
            title: title,
            writer: writer,
            catergory: catergory,
        ...
        this.http.post(BACKED_URL + '/post', postData)
            ...
            _this.postsUpdated.next(_this.posts);
            _this.location.back();
            // this.router.navigate(['/']);
        });
    };
    // 게시글 삭제
    PostService.prototype.deletePost = function (postNo) {
        var _this = this;
    ...
    // 게시글 수정
    PostService.prototype.updatePost = function (postNo, title, content, imagePath) {
        var _this = this;
        var postData = {
            title: title,
            content: content,
    ...
    // 댓글 저장하기
    PostService.prototype.addReply = function (postNo, nickname, reply, token) {
        var postData = {
            postNo: postNo,
            nickname: nickname,
            reply: reply,
    ...
    // 댓글 불러오기
    PostService.prototype.getReply = function (postNo, pages) {
        var queryParams = "?postNo=" + postNo + "&pages=" + pages;
        return this.http.get(BACKED_URL + '/reply' + queryParams);
    };
    // 덧글 저장하기
    PostService.prototype.addRReply = function (postNo, nickname, reply, parent, token) {
        var postData = {
            postNo: postNo,
            nickname: nickname,
            reply: reply,
    ...
    // 덧글 조회하기
    PostService.prototype.getRReply = function (postNo, parent, pages) {
        var queryParams = "?postNo=" + postNo + "&parent=" + parent + "&pages=" + pages;
        return this.http.get(BACKED_URL + '/reply/reply' + queryParams);
    };
    // 사용자 검색
    PostService.prototype.getSearchPost = function (searchInput, pages) {
        var queryParams = "?search=" + searchInput + "&pages=" + pages;
        // 백엔드 통신
        return this.http.get(BACKED_URL + '/post/search' + queryParams);
    };
    // 내 게시글 조회
    PostService.prototype.getMyPosts = function (nickname, pages) {
        var queryParams = "?nickname=" + nickname + "&pages=" + pages;
        // 백엔드 통신
        return this.http.get(BACKED_URL + '/post/mypost' + queryParams);
    };
    // 댓.답글 삭제
    PostService.prototype.deleteReply = function (postNo, replyNo, parent) {
        var queryParams = "?postNo=" + postNo + "&replyNo=" + replyNo + "&parent=" + parent;
